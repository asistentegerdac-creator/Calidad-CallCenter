  ...
  return (
    <div className="space-y-8 animate-in fade-in zoom-in-95 duration-500">
      <div className="glass-card p-10 bg-slate-900 text-white border-none shadow-2xl relative overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-10 relative z-10">
          <div>
            ...
            <p className="text-slate-400 text-[10px] font-black uppercase tracking-[0.2em] mt-1">REGISTRO DIARIO DE OPERACIONES</p>
          </div>
          <div className="bg-slate-800 p-2 rounded-2xl flex items-center gap-4">
             <span className="text-[10px] font-black uppercase text-slate-500 ml-4">Fecha:</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="glass-card p-8 bg-white border border-slate-100">
        ...
        <div className="glass-card p-8 bg-white border-l-8 border-emerald-500 shadow-sm">
        ...
        <div className="glass-card p-8 bg-white border-l-8 border-rose-500 shadow-sm">
        ...
        <div className="glass-card p-10 bg-white border border-slate-100 shadow-sm min-h-[450px]">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <AreaChart data={dailyStats.slice(0, 14).reverse()}>
              ...
              <Tooltip />
              <Area type="monotone" dataKey="patients_attended" name="Atendidos" stroke="#6366f1" strokeWidth={4} fillOpacity={1} fill="url(#colorAtt)" />
            </AreaChart>
          </ResponsiveContainer>
        </div>
      </div>
